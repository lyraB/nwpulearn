package com.nwpu.search.service.impl;
...
public class CourseSearchServiceImpl implements CourseSearchService {
    ...
    public SearchPageResultDto<CourseIndex> queryCoursePubIndex(PageParams pageParams, SearchCourseParamDto courseSearchParam) {
        ...
        searchSourceBuilder.fetchSource(sourceFieldsArray, new String[]{}); // 分别是需要包含和不包含的，指定一个即可，另一个可为空
        if (courseSearchParam == null) { // 未指定搜索词（空点搜索按钮）
        ...
        searchSourceBuilder.from(start); // 从某一条开始返回
        searchSourceBuilder.size(Math.toIntExact(pageSize)); // 返回的查询结果hits数量
        //布尔查询
